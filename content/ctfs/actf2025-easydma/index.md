...
series: ["pwn", "qemu", "cve"] # pwn, stack, heap, shellcode, cpp, go, sandbox, qemu, kernel, windows, arm, aarch64, mips, ppc, realword, reverse, cve
...
tags: ["ctf", "pwn", "qemu", "virtio", "DMA Reentrancy", "CVE", "virtqueue(vring)"]
